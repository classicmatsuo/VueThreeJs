...
// beta test
FuzzyMesh.prototype.setSize = function(size) {
  this.config.hairLength = size;
  // this.baseMesh.material.hairLength.set(size);
  // this.material.uniforms.hairLength.value.set(size); 
  // console.log(this.config.hairLength);
};
